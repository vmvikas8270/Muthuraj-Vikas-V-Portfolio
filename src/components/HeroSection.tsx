...
const HeroSection = () => {
  return <section id="home" className="min-h-screen flex items-center relative overflow-hidden pt-16">
      ...
      <div className="floating-dot w-4 h-4 bg-primary top-32 left-20" style={{
      animationDelay: "0s"
    }} />
      <div className="floating-dot w-6 h-6 bg-secondary top-48 right-32" style={{
      animationDelay: "1s"
    }} />
      <div className="floating-dot w-3 h-3 bg-accent top-64 left-1/3" style={{
      animationDelay: "2s"
    }} />
      <div className="floating-dot w-8 h-8 bg-primary/30 bottom-32 left-16" style={{
      animationDelay: "3s"
    }} />
      <div className="floating-dot w-5 h-5 bg-accent/50 bottom-48 right-20" style={{
      animationDelay: "4s"
    }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          duration: 0.6
            ...
            <div className="flex flex-wrap gap-3 mb-8">
              {skills.map((skill, index) => <motion.span key={skill.label} initial={{
              opacity: 0,
              scale: 0.8
            }} animate={{
              opacity: 1,
            ...
            <div className="flex items-center gap-4">
              <a href="https://github.com/vmvikas8270" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-muted hover:bg-muted/80 transition-colors">
                <Github size={20} />
              </a>
              <a href="https://leetcode.com/u/MUTHURAJ_VIKAS_V2002/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-muted hover:bg-muted/80 transition-colors">
                <Code2 size={20} />
              </a>
            </div>
          </motion.div>
          ...
          delay: 0.2
            ...
            <div className="relative">
              ...
              <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full overflow-hidden border-4 border-card shadow-card">
                <img src={profileImage} alt="Muthuraj Vikas V" className="w-full h-full object-cover" key={profileImage} />
              </div>
